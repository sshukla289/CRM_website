...
function MarqueeRow({ items, directionClass }) {
  return (
    <div className="pause-on-hover relative w-full overflow-hidden mask-gradient">
      <div data-marquee-track className={`flex w-max transform-gpu items-stretch ${directionClass} py-3`}>
